...
class About extends Super
{
  ...
  public function about()
    ...
    return redirect()->to(base_url('Cms/Login/index'))->send(); // Ensure correct URL and use base_ur
        ...
        $data = array();
        $data['db_table_name'] = "about";
        $data['record_name']   = "aboutus";
        $data['records_name'] = $data['menu_active'] = "aboutus";
        $data['form_link'] = site_url("cms/about/about_form/");
        $data['table_link'] = site_url("Cms/about/about");
        ...
        $data['records'] = $this->AboutModel->selectabout_model_m();
    ...
    public function about_form($id = 0)
    {
        $data = array();
        $data['db_table_name'] = "about";
        $data['record_name']   = "aboutus";
        $data['records_name'] = $data['menu_active'] = "aboutus";
        $data['table_link'] = site_url("Cms/about/about");
        $data['submit_link'] = site_url("Cms/about/about_save");
        $data['id'] = $id;
        ...
        return $this->render("about_form", $data);
    }
    public function about_save()
    {
        ...
        if (!empty($photo)) {
            ...
            $about = $this->SuperModel->selectSingleData_m($tableName, $id);

            $uploadImage = $about['image'];
        }
        ...
        if (!$id > 0) {
            ...
            $this->swalSuccess(site_url("Cms/about/about"));
        }
        die();
        return  redirect()->to('Cms/about/about');
    }
