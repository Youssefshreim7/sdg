							...
							<div class="card">
								<div class="card-body">
									<div class="row">
										...
										<!-- Value Textarea -->
											<div class="col-lg-12">
												<div class="mb-3">
													...
													<textarea id="editor_value" name="value" rows="10" cols="80" class="form-control">
														<?= @$record['value'] ?>
													</textarea>
												</div>
											</div>
										...
										<div class="col-lg-6">
											<div class="mb-3">
												<label class="form-label" for="project-thumbnail-img">Image (777x855)</label>
										...
										<div class="col-lg-6">
											<div class="mb-3">
												...
												<img src="<?= base_url() . '/uploads/' . @$record['image'] ?>" width="175px" alt="Current Image">
											</div>
										</div>
										<?php } ?>
									</div>
