					...
					<form  method="POST" action="<?= $submit_link ?>" autocomplete="off"  autocomplete="off"  enctype="multipart/form-data">
                      ...
                      <div class="row">
                           <div class="col-lg-6">
												...
												<div class="col-lg-6">
											 <div class="mb-3">
												 <label class="form-label" for="project-title-input">Date</label>
																																																																																																																																																																																																																																																																				 <input type="date"  name="date" class="form-control"   placeholder="Enter date" value="<?= @$record['date'] ?>">
											</div>
										 </div>
                         ...
                         <div class="col-lg-6">
                         <div class="mb-3">
                              <label class="form-label" for="project-thumbnail-img"> Image(1200x800)</label>
