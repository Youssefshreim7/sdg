<div class="page-content">
   ...
   var KTUppy = function () {
     ...
     var initUppy2 = function(){
       ...
       // uppyDashboard.use(Tus, { endpoint: '<?= site_url('admin/news_gallery_save/'.$id);?>' });

       uppyDashboard.use(XHRUpload, {
         endpoint: '<?= site_url('cms/news/news_gallery_save/'.$id);?>',
         fieldName: 'file_name'
       })
   ...
   function refreshFiles(){
     $.ajax({
       url : "<?= site_url('cms/news/get_news_gallery/'.$id); ?>",
       type : 'POST',
       data : {},
