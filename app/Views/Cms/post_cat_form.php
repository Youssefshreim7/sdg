				...
				<div class="row">
					<form  method="POST" action="<?= $submit_link ?>" autocomplete="off"  autocomplete="off"  enctype="multipart/form-data">
                      ...
                      <div class="row">
                           ...
                           <div class="col-lg-12">
  												<div class="mb-3">
														<label class="form-label" for="project-title-input">Post category Title</label>
																																																																																																																																																																																																																																																										                      	<input type="text"  name="name" class="form-control"   placeholder="Enter Post category Title" value="<?= @$record['name'] ?>">
                         </div>
                        </div>
