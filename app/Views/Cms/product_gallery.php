<div class="page-content">
   ...
   var KTUppy = function () {
     ...
     var initUppy2 = function(){
       ...
       // uppyDashboard.use(Tus, { endpoint: '<?= site_url('admin/products_gallery_save/'.$id);?>' });

       uppyDashboard.use(XHRUpload, {
         endpoint: '<?= site_url('cms/product/products_gallery_save/'.$id);?>',
         fieldName: 'file_name'
       })
   ...
   function refreshFiles(){
     $.ajax({
       url : "<?= site_url('cms/product/get_products_gallery/'.$id); ?>",
       type : 'post',
       data : {},
