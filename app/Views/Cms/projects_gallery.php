<div class="page-content">
   ...
   var KTUppy = function () {
     ...
     var initUppy2 = function(){
       ...
       // uppyDashboard.use(Tus, { endpoint: '<?= site_url('admin/projects_gallery_save/'.$id);?>' });

       uppyDashboard.use(XHRUpload, {
         endpoint: '<?= site_url('cms/projects/projects_gallery_save/'.$id);?>',
         fieldName: 'file_name'
       })
   ...
   function refreshFiles(){
     $.ajax({
       url : "<?= site_url('cms/projects/get_projects_gallery/'.$id); ?>",
       type : 'POST',
       data : {},
