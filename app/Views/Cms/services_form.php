	...
	<div class="container-fluid">
		...
		<div class="row">
			<form method="POST" action="<?= $submit_link ?>" autocomplete="off" autocomplete="off" enctype="multipart/form-data">
							...
							<div class="row">
								...
								<div class="col-lg-12">
									<div class="mb-3">
										...
										<textarea name="description" id="editor1" rows="8" cols="80"><?= @$record['description'] ?></textarea>
									</div>
								</div>
								...
								<div class="col-lg-6">
									<div class="mb-3">
										<label class="form-label" for="project-thumbnail-img"> Image (1200x900)</label>
								...
								<div class="col-lg-6">
									<div class="mb-3">
										<label class="form-label" for="project-thumbnail-img">Icon (52x52)</label>
										<input class="form-control" name="icon" id="project-thumbnail-img" type="file" accept="image/png, image/gif, image/jpeg">
									</div>
								</div>
								...
								<?php if (@$record['icon']) { ?>
									<div class="form-group col-6">
										...
										<img src="<?= base_url() . '/uploads/' . @$record['icon'] ?>" width="175px">
									</div>
								<?php } ?>
							</div>
				...
				<input type="hidden" name="post_cat_id" value="1">
			</form>
			<!-- end col -->
		</div>
		<!-- end row -->
