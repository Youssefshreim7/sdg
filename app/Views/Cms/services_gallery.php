<div class="page-content">
   ...
   var KTUppy = function () {
     ...
     var initUppy2 = function(){
       ...
       // uppyDashboard.use(Tus, { endpoint: '<?= site_url('admin/services_gallery_save/'.$id);?>' });

       uppyDashboard.use(XHRUpload, {
         endpoint: '<?= site_url('cms/services/services_gallery_save/'.$id);?>',
         fieldName: 'file_name'
       })
   ...
   function refreshFiles(){
     $.ajax({
       url : "<?= site_url('cms/services/get_services_gallery/'.$id); ?>",
       type : 'POST',
       data : {},
