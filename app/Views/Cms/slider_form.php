							...
							<div class="row">
								<div class="col-lg-6">
									<div class="mb-3">
										...
										<input type="text" name="name" class="form-control" placeholder="Enter Title EN" value="<?= @$record['name'] ?>">
									</div>
								</div>
								...
								<div class="col-lg-6">
									<div class="mb-3">
										<label class="form-label" for="project-title-input">Button Title</label>
										<input type="text" name="btn_text" class="form-control" placeholder="Enter Button Title EN" value="<?= @$record['btn_text'] ?>">
									</div>
								</div>

								<div class="col-lg-6">
									<div class="mb-3">
										<label class="form-label" for="project-title-input">Button Action Link</label>
										<input type="text" name="btn_action_link" class="form-control" placeholder="Enter Button Action Link" value="<?= @$record['btn_action_link'] ?>">
									</div>
								</div>
								...
								<div class="col-lg-6">
									<div class="mb-3">
										<label class="form-label" for="project-thumbnail-img"> Image (1920x800)</label>
