                      ...
                      <div class="row">
                           <div class="col-lg-6">
  												<div class="mb-3">
												   ...
												   <div class="col-lg-6">
												<div class="mb-3">
													<label class="form-label" for="project-title-input">Class</label>
																																																																																																																																																																																																																																																																					<input type="text"  name="class" class="form-control"   placeholder="Enter Class" value="<?= @$record['class'] ?>">
											 </div>
											 	 </div>

												 <div class="col-lg-6">
											<div class="mb-3">
												<label class="form-label" for="project-title-input">Link</label>
																																																																																																																																																																																																																																																																				<input type="text"  name="link" class="form-control"   placeholder="Enter Link" value="<?= @$record['link'] ?>">
										 </div>
											 </div>
