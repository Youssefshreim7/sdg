       ...
       <div class="breadcrumb-area ptb-100 bg-img text-center" data-bgimg="<?= base_url() . '/assets/public/' ?>/image/other/nbackground.jpg">>
           <div class="container">
               <span class="d-block extra-color"><a href="index.html" class="extra-color">Home</a> - <?php echo $cat_info['name']; ?></span>
               <h2 class="extra-color font-24 font-xl-32 mst-4 mst-xl-7"><?php echo $cat_info['name']; ?></h2>
           </div>
       </div>
       <!-- breadcrumb-area end -->
       <!-- main start -->
                           ...
                           <div class="shop-sidebar-wrap shop-filter-sidebar" data-animate="animate__fadeIn">
                               ...
                               <form class="shop-form" action="javascript:void(0)" id="shopForm">
                                   ...
                                   <div class="shop-sidebar shop-categories">
                                       <h6 class="font-18">Subcategory</h6>
                                       <div class="shop-cat-post mst-20">
                                           <div class="shop-cat ul-mtm-15">
                                                ...
                                                <?php foreach ($subcatrelated as $key => $valuee): ?>
                                                   ...
                                                   <a href="<?= site_url('home/products_by_subcat/' . $valuee['cat_id'] . '/' . $valuee['id']); ?>" class="body-primary-color d-flex align-items-center justify-content-between">
                                                       <span><?= esc($valuee['name']); ?></span>
                               ...
                               <div class="col-12">
                                   <div class="shop-product-wrap data-grid">
                                       ...
                                       <div class="row row-mtm">
                                           <?php foreach ($prod_by_cat as $key => $value) { ?>
