    <div class="breadcrumb-area ptb-100 bg-img text-center" data-bgimg="<?= base_url() . '/assets/public/' ?>/image/other/nbackground.jpg">
        <div class="container">
            <span class="d-block extra-color"><a href="index.html" class="extra-color">Home</a> - Projects</span>
            <h2 class="extra-color font-24 font-xl-32 mst-4 mst-xl-7">Projects</h2>
        </div>
    </div>
    <!-- breadcrumb-area end -->
    <!-- main start -->
