                    <div class="breadcrumb-area ptb-100 bg-img text-center" data-bgimg="<?= base_url() . '/assets/public/' ?>/image/other/nbackground.jpg">
                        <div class="container">
                            <span class="d-block extra-color"><a href="index.html" class="extra-color">Home</a> - Projects Details</span>
                            <h2 class="extra-color font-24 font-xl-32 mst-4 mst-xl-7"><?= $projectsinfo['name']; ?></h2>
                        </div>
                    </div>
                    <!-- breadcrumb-area end -->
                    <!-- main start -->
                                    ...
                                    <div class="col-12 col-lg-4 col-xxl-3 p-lg-sticky top-0">
                                        <div class="blog-sidebar-wrap">
                                            ...
                                            <div class="blog-post-sidebar blog-recent" data-animate="animate__fadeIn">
                                                <h6 class="font-18">Recent Projects</h6>
