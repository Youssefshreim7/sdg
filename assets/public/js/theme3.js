(function($) {
    ...
    var ST = {
        ...
        cartDrawer: function() {
            // open cart drawer (using event delegation)
            $document.on("click", "a.js-cart-drawer, a.bottom-menu-cart", function(e) {
                e.preventDefault();
                miniCart();
            });
            // close cart drawer (using delegated events for dynamic elements)
            ...
            $document.on("click", ".add-to-cart", function(event) {
                ...
                // use setTimeout for loading simulation
                setTimeout(function() {
                    $this.removeClass("loading").addClass("done");
                    setTimeout(function() {
                        $this.removeClass("done active disabled");
                        miniCart();
                        // close quickview modal safely
                        var $quickviewModal = $this.closest(".quickview-modal");
                        if($quickviewModal.length === 1) {
                            $quickviewModal.find(".quickview-modal-header button").trigger("click");
                        }
                    }, 500);
                }, 500);
            });
