...
* [CodeIgniter 4 User Guide on Testing](https://codeigniter.com/user_guide/testing/<?= site_url('home'); ?>)
...
The HTML files can be viewed by opening **tests/coverage/<?= site_url('home'); ?>** in your favorite browser.
